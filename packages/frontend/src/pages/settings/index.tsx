          ...
          <section tw="flex flex-col gap-2">
            ...
            <div tw="flex flex-col gap-2">
              <div tw="flex flex-col gap-0">
                ...
                <p tw="text-left text-sm text-[#59697D]">
                  This is so that we are able to send you live updates about any recalled products
                  in that location.
                </p>
              </div>
              <StyledSelect
            ...
            <div tw="flex flex-col gap-2">
              <div tw="flex flex-col gap-0">
                ...
                <p tw="text-left text-sm text-[#59697D]">
                  These are locations that are being tracked. You will receive notifications if
                  there is a recalled food in any of the following locations.
                </p>
              </div>
              <div tw="flex flex-col gap-2">
          ...
          <section tw="flex flex-col gap-2">
            ...
            <div tw="flex flex-col gap-2">
              <div tw="flex flex-col gap-0">
                ...
                <p tw="text-left text-sm text-[#59697D]">
                  These are products that are being observed. You will receive notifications if any
                  of the following products are recalled.
                </p>
              </div>
              <div tw="flex flex-col gap-2">
