      ...
      <form>
        ...
        <section tw="mb-8">
          ...
          <div tw="flex flex-col gap-2">
            ...
            <div tw="flex items-center gap-2">
              <input type="checkbox" value="I don't want to receive notifications" /> I don&apos;t
          ...
          <div tw="flex flex-col gap-2">
            ...
            <div tw="flex flex-col gap-2">
              {trackedLocations.map(location => (
                <div
                  key={location}
                  tw="flex justify-between py-[12px] px-[16px] bg-[#FDFDFF] border border-light-neutral-200 rounded-xl shadow-1"
                >
                  <p>{location}</p>
